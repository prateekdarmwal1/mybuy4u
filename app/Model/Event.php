...
class Event extends AppModel
{
    ...
    function  get_detail_by_event_id($id)
    {
        try {
            $result = $this->find('first', array('conditions' => array('Event.ID' => $id)));
            return $result;
        } catch (Exception $exception) {
            echo $exception->getMessage();
        }
    ...
    function  get_event_place_product($id)
    {
        try {
            $result = $this->find('all', array('conditions' => array('Event.EVENT_PLACE_ID' => $id)));
            return $result;
        } catch (Exception $exception) {
            echo $exception->getMessage();
        }
