...
class ShopCategory extends AppModel
{
    ...
    {
        try {
            $results = $this->find("all", array("fields" => array("ID", "TYPE","TITLE","IMAGE_PATH"), "order" => "TITLE asc"));
            return $results;
        } catch (Exception $exception) {
            echo $exception->getMessage();
        }
    ...
    {
        try {
            $results = $this->find("list", array("fields" => array("ID", "TITLE"), "order" => "TITLE asc"));
            return $results;
        } catch (Exception $exception) {
            echo $exception->getMessage();
        }
    ...
    {
        try {
            $results = $this->find("first", array('conditions' => array('ShopCategory.id' => $id),"fields" => array("ID", "TYPE", "TITLE"), "order" => "TITLE  asc"));
            return $results;
        } catch (Exception $exception) {
            echo $exception->getMessage();
        }
