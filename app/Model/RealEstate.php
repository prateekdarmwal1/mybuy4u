...
class RealEstate extends AppModel
{
    ...
    var $hasOne = array(
        ...
        'BusinessBannerImage' => array(
            ...
            'conditions' => array('BusinessBannerImage.BUSINESS_TYPE' =>'real_estates'),
            'order' => '',
            'limit' => '',
    ...
    function  get_real_estate_detail($id)
    {
        try {
            $result = $this->find('all', array('conditions' => array('RealEstate.ID' => $id)));
            return $result;
        } catch (Exception $exception) {
            echo $exception->getMessage();
        }
    ...
    function  get_realestates_detail($id)
    {
        try {
            $result = $this->find('first', array('fields' => array('RealEstate.TOTAL_PRICE'),'conditions' => array('RealEstate.ID' => $id)));
            return $result;
        } catch (Exception $exception) {
            echo $exception->getMessage();
        }
    ...
    function  get_real_estate_detail_for_home_page()
    {
        try {
    ...
    function  get_detail_by_realestate_id($id)
    {
        try {
            $result = $this->find('first', array('conditions' => array('RealEstate.ID' => $id)));
            return $result;
        } catch (Exception $exception) {
            echo $exception->getMessage();
        }
    ...
    function get_lands_for_home_page()
    {
        try {
            $fields = array("RealEstate.ID", "OWNER_ID", "ADDRESS", "COST", "COST_UNIT", "LAND_TYPE", "SIZE", 'UPDATED_DATE');
    ...
    {
        try {
            $fields = array("RealEstate.ID", "NAME", "SIZE", "FACING", "SHAPE", "APPROVAL", "COST", "LAND_TYPE",
    ...
    /*function  get_land_image($id)
    {
        try {
            $results = $this->LandImage->find('all', array('conditions' => array('LandImage.LAND_ID' => $id),
                                                          "order" => "LandImage.ID asc"));
            return $results;
        } catch (Exception $exception) {
            echo $exception->getMessage();
        }
        ...
        try {
            ...
            if (!empty($results)) {
                foreach ($results as $result) {
                    $temp_result["ID"] = $result["RealEstate"]["ID"];
                    $temp_result["NAME"] = $result["RealEstate"]["NAME"];
                    $temp_result["DESCRIPTION"] = $result["RealEstate"]["DESCRIPTION"];
                    $temp_result["COST"] = $result["RealEstate"]["COST"];
                    $temp_result["CATEGORY"] = $result["LandType"]["NAME"];
                    $temp_result["IMAGE_PATH"] = $result["LandImage"]["IMAGE_PATH"];
