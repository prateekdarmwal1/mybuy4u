 ...
 * <p>ImageResizeComponent used to resize image</p>
 */
class ImageResizeComponent extends Component {
    ...
    public function resize($original, $new_filename, $new_width = 0, $new_height = 0, $quality = 100) {
        //$original = $_SERVER['DOCUMENT_ROOT'].DS.'mybuy4u'.$original;
        //$new_filename = $_SERVER['DOCUMENT_ROOT'].DS.'mybuy4u'.$new_filename;
        
        //$original = $_SERVER['DOCUMENT_ROOT'].$original;
        //$new_filename = $_SERVER['DOCUMENT_ROOT'].$new_filename;

        $original = '/home/mybuye4p/public_html'.$original;
        $new_filename = '/home/mybuye4p/public_html'.$new_filename;
     ...
     * of errors on failure
     */
    function resizePhp4($original, $new_filename, $new_width = 0, $new_height = 0, $quality = 100) {
        if (!($image_params = getimagesize($original))) {
            $this->__errors[] = 'Original file is not a valid image: ' . $original;
            return false;
        }
        ...
        switch ($ext) {
            case IMAGETYPE_GIF:
                $return = $this->__resizeGifPhp4($original, $new_filename, $scaled_width, $scaled_height, $width, $height, $quality);
                break;
            case IMAGETYPE_JPEG:
                $return = $this->__resizeJpegPhp4($original, $new_filename, $scaled_width, $scaled_height, $width, $height, $quality);
                break;
            case IMAGETYPE_PNG:
                $return = $this->__resizePngPhp4($original, $new_filename, $scaled_width, $scaled_height, $width, $height, $quality);
                break;
            default:
                $return = $this->__resizeJpegPhp4($original, $new_filename, $scaled_width, $scaled_height, $width, $height, $quality);
                break;
    ...
    function getErrorsPhp4() {
        return $this->__errors;
    }

    function __resizeGifPhp4($original, $new_filename, $scaled_width, $scaled_height, $width, $height, $quality) {
        $error = false;
    ...
    function __resizeJpegPhp4($original, $new_filename, $scaled_width, $scaled_height, $width, $height, $quality) {
        $error = false;
    ...
    function __resizePngPhp4($original, $new_filename, $scaled_width, $scaled_height, $width, $height) {
        $error = false;
