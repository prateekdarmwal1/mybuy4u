...
<?php
    ...
    echo $this->Html->script('angular/angular-route.min.js');
    //echo $this->Html->script("angular/app/script/app.js");
    //echo $this->Html->script("angular/app/script/controllers/top_tab.js");
...
<div id="container">
    ...
    <div class="breadcrumb">
        ...
        //debug($controller);
        echo $this->element(strtolower($controller)."_bread_crumb");?>
    </div>
