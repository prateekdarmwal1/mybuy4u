<?php
$this->assign( 'head_description', 'mybuy4u local business - ngo' );
$this->assign( 'head_keywords', 'mybuy4u local business - ngo' );
?>
                    ...
                    <div class="vk_left_outer_top_two">
                        ...
                        <div class="vk_left_content_inner1">
                            ...
                            <div class="yk_left_content_inner2_top_twovk">
                                ...
                                <div class="yk_text2">
                                    <?php echo isset($result["Ngo"]["MOBILE_NUMBER"])?$result["Ngo"]["MOBILE_NUMBER"]:'';?>
                                </div>
                                <div class="clear_both"></div>
                                <div class="yk_text1 ">
                                    Posted Date:
