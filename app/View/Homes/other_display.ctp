<?php
$this->assign( 'head_description', 'mybuy4u local business - other' );
$this->assign( 'head_keywords', 'mybuy4u local business - other' );
?>
    ...
    <div class="yk_main_bottom_content1">
        <div class="yk_bottom_content">
            ...
            <div id="mainContent" class="left_content">
                ...
                <?php foreach ($other as $result) : /* print_r($shop);*/ ?>
                    ...
                    <div class="vk_left_outer_top_two">
                        ...
                        <div class="vk_left_content_inner1">
                            ...
                            <div class="yk_left_content_inner2_top_twovk">
                                ...
                                <div class="yk_text2">
                                    <?php echo isset($result["Other"]["OWNER"])?$result["Other"]["OWNER"]:''; ?>
                                </div>
                                <div class="clear_both"></div>
                                <div class="yk_text1 ">
                                    Contact:
                                ...
                                <div class="yk_text2">
                                    <?php echo isset($result["Other"]["MOBILE_NUMBER"])?$result["Other"]["MOBILE_NUMBER"]:'';?>
                                </div>
                                <div class="clear_both"></div>
                                <div class="yk_text1 ">
                                    Posted Date:
