            ...
            <div class="width75" style='float:left;'>
                ...
                <div class="yk_template_slider_content">
                    <div class="right_heading">
                        <ul class="list">
                            ...
                            <li>
                                <div
                                    id='create'><?php echo $this->Html->link('View', array("controller" => "event_or_places", "action" => "view_product/" . $event_place_id . '/' . $model_name));?>
                            </li>
                        </ul>
                    </div>
                                ...
                                <div class="img_text">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        ...
                                        <div class="span3 fileupload-new fileupload-exists">
                                            <?php echo $this->Form->input('EventImage.IMAGE_PATH', array("label" => false, "class" => "finish_upload1", "type" => "file")) ?>
                                        </div>
                ...
                <div class="clear_both"></div>
                            ...
                            <div class="div_text">
                                ...
                                <div class="text_box">
                                    <?php echo $this->Form->input("Event.EVENT_TYPE", array("", "label" => false, "class" => "", "type" => "text",'required'=>true)) ?>
                                </div>
                                <div class="clear_both"></div>
                            </div>
                        </div>
                    ...
                    <div id="list_div" style="display:none;">
                        ...
                        <div class="template_name">
                            <div class="">
                                <?php echo $templates['Event']['NAME']; ?>
                                <div class="option_data">
                                    <div
                                        class="edit_btn"> <?php echo $this->Html->link('Update', array('controller' => 'event_or_places', 'action' => 'update_event/' . $event_place_id . "/" . $model_name . '/' . $templates['Event']['ID'])); ?></div>
                                    <div class="delete_btn">
                                        /<?php echo $this->Html->Link('Delete', array('controller' => 'event_or_places', 'action' => 'delete_event/' . $event_place_id ."/" . $model_name . '/'. "/" . $templates['Event']['ID'])
