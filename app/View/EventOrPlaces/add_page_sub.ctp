...
<div class="vsp_main_content">
    ...
    <?php $url = array("controller" => "event_or_places", "action" => "add_page/" . $product_id.'/'.$model_name);
    ...
    <div class="width75" style="padding:8px;">
        <div class="yk_template_slider_content" style="padding:8px;">
            <div class="right_heading"><?php echo $this->Html->link('View' , array("controller" => "event_or_places", "action" => "display_addpage/".$product_id.'/'.$model_name));?> | Upload Product | Update E-Shop</div>
            <div class="clear_both"></div>
