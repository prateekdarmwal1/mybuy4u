<?php
 $url = array("controller" => "event_or_places", "action" => "event_or_place_details/" . $event_place_id);
...
<div class="vsp_main_content">
    <div class="vsp_left_side margin">
        <div class="right_heading">Event / Place Detail</div>
        <div class="clear_both"></div>
        <div class="">
            <?php echo $this->Form->input('EventPlace.NAME', array("label" => false, "class" => "input_box", "placeholder" => "Business Name", "maxlength" => "50")) ?>
            ...
            <?php echo $this->Form->TextArea('EventPlace.DESCRIPTION', array("required", "label" => false, 'class' => 'finish_des_margin ckeditor', 'width' => '', 'height' => 100)) ?>
        </div>
            <div class="clear_both"></div>
        ...
        <div class="clear_both"></div>
            ...
            <div class="text_box">
               <?php echo $this->Form->input('EventPlace.MOBILE_NUMBER', array("label" => false, 'class' => 'yk_text_box_brand1', 'Placeholder' => 'Mobile', "type" => "text", "maxlength" => "10")) ?>
            </div>
            <div class="clear_both"></div>
        </div>
            <div class="clear_both"></div>
        ...
        <div class="div_text">
            ...
            <div class="text_box">
                <?php echo $this->Form->select('Address.COUNTRY', $countries, array("empty" => "--Select--", 'style'=> 'width: 167px; height: 22px;',
                                                                          "onChange" => "show_state_by_country2(this.value);"), array('label' => false, 'class' => 'span yk_add_banner_select')); ?>
            </div>
            <div class="clear_both"></div>
        </div>
        <div class="div_text">
            ...
            <div class="text_box" id='state_id'>
                <?php echo $this->Form->input('Address.STATE', array('label' => false, 'style'=> 'width: 167px; height: 22px;','type'=>'select','id'=>'AddressState',"empty" => "--Select--",
        ...
        <div class="clear_both"></div>
            ...
            <div class="div_text" id='div1' style="display:none">
                ...
                <div class="text_box">
                    <?php echo $this->Form->input('TOTAL_PRICE', array("label" => false, "class" => "", 'Placeholder' => 'Total Price', "type" => "text", 'value' => '500', "maxlength" => "10")) ?>
                </div>
                <div class="clear_both"></div>
            </div>
        </div>
    ...
    <div class="margin">
        ...
        <div class="div_text">
            ...
            <div class="text_box">
                <?php echo $this->Form->input('Owner.MOBILE_NUMBER', array("required", "label" => false, "class" => "", 'Placeholder' => 'Mobile Number', "type" => "text", "maxlength" => "10")) ?>
            </div>
            <div class="clear_both"></div>
        </div>
        ...
        <div class="save_button_3" style="margin-top: 10px;">
