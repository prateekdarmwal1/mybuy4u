...
<div class="vsp_main_content">
    ...
    <?php $url = array("controller" => "company_organizations", "action" => "add_page/" . $company_id.'/'.$model_name);
    ...
    <div class="width75" style="padding:8px;">
        <div class="yk_template_slider_content" style="padding:8px;">
            <div class="right_heading"><?php echo $this->Html->link('View' , array("controller" => "company_organizations", "action" => "display_addpage/".$company_id.'/'.$model_name));?> | Upload Product | Update E-Shop</div>
            <div class="clear_both"></div>
