...
<div class="yk_template_slider_content " style="padding:8px;">
        ...
        <div class="yk_template_slider_content_left_upno yk_left10no">
            <div class="yk_template_slider_content_left_tableno ">
                        ...
                        <span class="ab_product_text_1"> : </span><div class="ab_font_12">
                            <?php echo $details['Product']["NAME"]?>    <!--Bridal Lehanga-->
                        </div>


                        <span class="ab_product_text">Price </span>
                        <span class="ab_product_text_1"> : </span>  <div class="ab_font_12">
                            <?php echo $details['Product']["COST"]?>    <!--Not Available-->
                        </div>


                <span class="ab_product_text">Description</span></td>
                <span class="ab_product_text_1"> : </span>  <div class="ab_font_12">
    ...
    <div class="al_event_left_content">
        ...
        <?php
            //debug($results);exit;
            echo $results['ProductBrand']["DESCRIPTION"]
        ?>
        ...
        <div class="">
            ...
            <div class="main">
                ...
                <ul id="carousel" class="elastislide-list">
                    ...
                    $img_path = "http://" . $_SERVER["SERVER_NAME"] . $details["ProductImage"]["IMAGE_PATH_BIG"];

                    ?>
                    <li data-preview="<?php echo $img_path; ?>" id="product_id_<?php echo $i ?>"
                        onclick="show_detail('<?php echo $i ?>')">
                        <?php echo $this->Html->image($img_path, array('width' => 90, 'height' => 92,'class'=>'border1')) ?>
                    </li>
                    <?php endforeach;?>
                </ul>
