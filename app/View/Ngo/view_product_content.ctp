...
<div class="yk_template_slider_content " style="padding:8px;">
    <?php  foreach ($detail as $i => $details) :  /*print_r($details); */ ?>
            ...
            <div class="yk_template_slider_content_left_tableno ">
                    ...
                    <span class="ab_product_text">Name </span>
                        <span class="ab_product_text_1"> : </span><div class="ab_font_12">
                            <?php echo $details['Page']["NAME"]?>    <!--Bridal Lehanga-->
                        </div>
                       <div class="clearfix"></div>
<!---->
<!--                        <span class="ab_product_text">Price </span>-->
<!--                        <span class="ab_product_text_1"> : </span> <div class="ab_font_12">-->
<!--                            --><?php //echo $details['Company']["STANDARD"]?><!--    <!--Not Available--
<!--                        </div>-->
<!---->
<!--                <div class="clearfix"></div>-->
<!---->
...
<!--                         <span class="ab_product_text_1"> : </span>  <div class="ab_font_12">-->
<!--                            --><?php //echo $details['Company']["DESCRIPTION"]?>
...
<!--                                </div>-->
    ...
    <div class="yk_template_slider_content_right">
        <div class="yk_imageno">
            <?php echo $this->Html->image('../images/template_left_content_user.png', array("class" => "yk_image","a_margin_top", 'width' => 168, 'height' => 245, 'id' => "preview"))?>
        </div>
    </div>
    <div class="clear_both"></div>
        ...
        <div class="">
            ...
            <div class="main">
                ...
                <ul id="carousel" class="elastislide-list">
                 ...
                 /* if(!empty($details["CompanyImage"]["IMAGE_PATH"])) {
                    $img_path = $details["CompanyImage"]["IMAGE_PATH"];
                    $img_path = explode("/", $img_path);
                    $temp=implode("/",array_slice($img_path,0,6));
                    $img_path_new = str_replace("/", "-", $temp);
                    $new_path_new = '/file/get_image/' . $img_path_new .'/'. $img_path[6];
             echo $this->Html->image($new_path_new, array("class" => "yk_template_main_image"));*/?>
                    ...
                    <?php $img_path = "http://" . $_SERVER["SERVER_NAME"] . $details["CompanyImage"]["IMAGE_PATH"];

                    ?>
                    <li data-preview="<?php echo $img_path; ?>" id="product_id_<?php echo $j ?>"
                        onclick="show_detail('<?php echo $j ?>')">
                        <?php echo $this->Html->image($img_path, array('width' => 90, 'height' => 92,'style'=>'cursor:pointer;','class'=>'border1')) ?>
                    </li>
                      <?php /*}*/?>
                    <?php endforeach;?>
                </ul>
