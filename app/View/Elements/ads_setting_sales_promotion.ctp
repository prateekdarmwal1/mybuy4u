...
$url = array("controller" => $this->request->params['controller'], "action" => "update_home_sale/" /*. $id_s . '/' */ . $shop_id . "/" . $model_name);
    ...
    <div class="ylk_add_banner_content_lower1">
        <div class="sale_upload1">
            ...
            <div class="border-green">
                <div class="tiny_mce_area">
                    <?php echo $this->form->textarea('HomeSale.DESCRIPTION', array("label" => false, 'class' => 'tiny_mce_area1 ckeditor', 'width' => "", 'height' => "")) ?>
                </div>
        ...
        <div class="yk_per_dayvk yk_top10vk">
            ...
            <div class="yk_pay_day_textvk yk_left30">
                ...
                <div onclick="total_sum()">
                    <div class="banner_calender" id="container1"></div>
                </div>
            </div>

            <div class="yk_pay_day_text yk_right60">
                <?php echo $this->Form->input('HomeSale.TOTAL_PRICE', array("label" => false, 'class' => 'yk_text_box_add_banner', "type" => "text", "id" => "sum", 'readonly')) ?>
                <?php ?>
            </div>
            <div class="clear_both"></div>
...
<script type="text/javascript">
    ...
    tab = function() {
        $('#datepicker-example7-start').Zebra_DatePicker({
            always_visible: $('#first'),
            direction: ['<?php echo $first_date?>', false]
        });
    };
