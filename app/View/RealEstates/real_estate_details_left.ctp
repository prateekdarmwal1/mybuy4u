...
<?php
// $url = array("controller" => "real_estates", "action" => "real_estate_details/" . $business_id);
echo $this->Form->create(array('inputDefaults' => array('divs' => 'control-group'), 'url' => array("controller" => "real_estates", "action" => "real_estate_details/" . $real_estate_id), "method" => "post", "enctype" => "multipart/form-data"));?>
<div class="vsp_main_content">
    <div class="vsp_left_side margin">
        <div class="right_heading"> Real Estate Detail</div>
        <?php echo $this->Form->input('RealEstate.NAME', array("label" => false, "class" => "input_box", "placeholder" => "Business Name", "maxlength" => "50")) ?>
        <div class="clear_both"></div>
        <div class="div_text">
...
<?php
                echo $this->Form->input('Address.STATE', array('label' => false,'type'=>'select',  'style'=> 'width: 167px; height: 22px;', "empty" => "--Select--",'id' => 'AddressState',"onChange" => "show_city_by_state2(this.value);")); ?>
            </div>
            <div class="clear_both"></div>
        </div>
        <div class="div_text">
...
<?php
                echo $this->Form->input('Address.CITY', array('type'=>'select',  'style'=> 'width: 167px; height: 22px;', 'id'=>'addressCity','label' => false, 'empty' => '--Select--')); ?>
            </div>
            <div class="clear_both"></div>
        </div>
        <div class="clear_both"></div>
        ...
        <div class="sale_checkbox">
            ...
            <div class="div_text" id='div1' style="display:none">
                ...
                <div class="text_box">
                    <?php echo $this->Form->input('TOTAL_PRICE', array("label" => false, "placeholder" => "Total Price", "class" => "", "type" => "text", 'value' => '500')) ?>
                </div>
                <div class="clear_both"></div>
            </div>
        </div>
    ...
    <div class="margin">
        ...
        <div class="clear_both"></div>
        <?php if (empty($this->request->data['Owner']['OwnerImage']['IMAGE_PATH'])) { ?>
        <div class="div_text">
