...
<div align="center">
    <div class="yk_template_main_image">
        ...
        <input type="hidden" id="address" name="address" value="<?php echo $results["Address"]["STREET_NAME"] . ", " . $results["Address"]["AREA_NAME"] . " ," . $results["Address"]["AREA_CODE"] ?>">
    </div>
    ...
    <div class="yk_template_slider_content " style="padding:8px;" id='m_view'>
        ...
        <div class="map_address">
            <?php echo $results[$model_name]['NAME']?> <br/>
