<div class="yk_main_content_top">
    <div class="main_content">
        <div class="vsp_main_content">
            ...
            <?php
                             $url = array("controller" => "real_estates", "action" => "update_apartment/" . $real_estate_id . '/' . $model_name . '/' . $apartment_id);
                ...
                <div class="yk_template_slider_content">
                    ...
                    <div id="send_div">
                        ...
                        <div class="div_text">
                            ...
                            <div class="text_box">
                                <?php echo $this->Form->input("Apartment.COST", array("", "label" => false, "class" => "", "type" => "text")) ?>
                            </div>
                            <div class="clear_both"></div>
                        </div>
                        <div class="div_text">
                            ...
                            <div class="text_box">
                                <?php echo $this->Form->input("Apartment.SIZE", array("", "label" => false, "class" => "", "type" => "text")) ?>
                            </div>
                            <div class="clear_both"></div>
                        </div>
                        <div class="div_text">
                            ...
                            <div class="text_box">
                                <div class="tiny_mce_text_area">
                                    <?php echo $this->Form->TextArea("Apartment.DESCRIPTION", array("", "label" => false, 'class' => 'tiny_mce_text_area', 'width' => "", 'height' => "")) ?>
                                </div>
                            </div>
                            <div class="clear_both"></div>
                        </div>
