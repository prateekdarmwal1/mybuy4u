<div class="yk_template_slider_content1">
    ...
    <div class="div_text">
        ...
        <div class="text_box">
            <?php echo $this->Form->input( 'JewelryImage.IMAGE_PATH', array("required", "label" => false, "class" => "", "type" => "file")) ?>
    ...
    <div class="div_text">
        <div class="text_">Weight :</div>
        <div class="text_box">
            <?php echo $this->Form->input('WEIGHT', array("", "label" => false, "class" => "", "type" => "text")) ?>
        </div>
        <div class="clear_both"></div>
    </div>
    <div class="div_text">
        <div class="text_">Colour :</div>
        <div class="text_box">
