<div class="yk_template_slider_content_left" style="display:none;"
        ...
        <div class="yk_template_slider_content_left_tableno ">
            <table>
                ...
                <tr>
                    ...
                    <td class="yk_font_12"><span class="yk_product_text"> : </span>
                        <?php echo $details[$modal]["COST"]?>(INR)    <!--Not Available-->
                    </td>
                </tr>
                <tr>
                    <td><span class="yk_product_text"> Size </span></td>
                    <td class="yk_font_12"><span class="yk_product_text"> : </span>
                        <?php echo $details[$modal]["SIZE"]?>    <!--All Available-->
                    </td>
                </tr>
                <tr>
    ...
    <!--<div class="yk_template_slider_content_left_down">
                        <?php /*echo $this->Html->link('SALES' , array("controller" => "local_business", "action" => "/". $result["Shop"]["SHOP_CATEGORY"]."/".$shop_id.'/'.$model_name));*/?>
                        SALES
                    </div>-->
</div>