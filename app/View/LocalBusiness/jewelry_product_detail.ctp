                        ...
                        <div class="yk_template_slider_content_left_tableno ">
                         ...
                         Product Details</span>
                              ...
                              Name </span></td>
                                ...
                                <tr>
                                    <td><span class="yk_product_text">weight </span></td>
                                    <td class="yk_font_12"><span class="yk_product_text"> : </span>
                                        <?php echo $details[$modal]["WEIGHT"]?>    <!--Not Available-->
                                    </td>
                                </tr>
                                <tr>
                                    <td><span class="yk_product_text">color </span></td>
                                    <td class="yk_font_12"><span class="yk_product_text"> : </span>
                                        <?php echo $details[$modal]["COLOR"]?>    <!--Not Available-->
                                    </td>
                                </tr>
                            </table>
                        </div>
