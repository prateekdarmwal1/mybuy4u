<div class="yk_template_slider_content1" style="padding:0px;">
    ...
    <div class="div_text">
        ...
        <div class="text_box">
            <?php $model_name_for_update = str_replace(' ','',$model_name_for_update);?>
    ...
    <div class="div_text">
        ...
        <div class="text_box">
            <?php echo $this->Form->input("$model_name_for_update.COST", array("", "label" => false, "class" => "", "type" => "text")) ?>
        </div>
        <div class="clear_both"></div>
    </div>
    <div class="div_text">
    ...
    <div class="div_text">
        ...
        <div class="text_box">
            <?php echo $this->Form->input("$model_name_for_update.BRAND_NAME", array("", "label" => false, "class" => "", "type" => "text")) ?>
        </div>
        <div class="clear_both"></div>
    </div>

    <div class="div_text">
        <div class="text_">Cost Unit:</div>
        <div class="text_box">
            <?php echo $this->Form->input("$model_name_for_update.COST_UNIT", array("", "label" => false, "class" => "", "type" => "text")) ?>
        </div>
        <div class="clear_both"></div>
    </div>
