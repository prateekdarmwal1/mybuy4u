<div class="yk_template_slider_content1" style="padding:0px;">
        ...
        <div class="div_text">
            ...
            <div class="fileupload fileupload-new"  data-provides="fileupload">
                ...
                <div class="span3 fileupload-new fileupload-exists">
                    <?php echo $this->Form->input('BookImage.IMAGE_PATH', array("label" => false, "class" => "finish_upload1", "type" => "file")) ?>
                </div>
   ...
   <!-- <div class="span2 border pull-right">ghvsagvdavdv
    ...
    <div class="div_text">
        <div class="text_">AUTHOR:</div>
        <div class="text_box">
            <?php echo $this->Form->input('AUTHOR', array("", "label" => false, "class" => "", "type" => "text")) ?>
        </div>
        <div class="clear_both"></div>
    </div>
    <div class="div_text">
        <div class="text_">PUBLISHER:</div>
        <div class="text_box">
            <?php echo $this->Form->input('PUBLISHER', array("", "label" => false, "class" => "", "type" => "text")) ?>
        </div>
        <div class="clear_both"></div>
    </div>
    <div class="div_text">
        <div class="text_">ISBN NUMBER:</div>
        <div class="text_box">
            <?php echo $this->Form->input('ISBN_NUMBER', array('maxlength' => '13', "label" => false, "class" => "", "type" => "text")) ?>
        </div>
        <div class="clear_both"></div>
    </div>
    <div class="div_text">
        <div class="text_">EDITION:</div>
        <div class="text_box">
            <?php echo $this->Form->input('EDITION', array("", "label" => false, "class" => "", "type" => "text",'required'=>true)) ?>
        </div>
        <div class="clear_both"></div>
    </div>
    <div class="div_text">
